...
fichier=open("D:/TP SAE 1-05/SAE15(1)/SAE15/Dumpfile.txt", "r")
...
plt.axis('equal')
plt.savefig("D:/TP SAE 1-05/SAE15(1)/SAE15//graphe1.png")
plt.show()
...
plt.savefig("D:/TP SAE 1-05/SAE15(1)/SAE15/graphe2.png")
plt.show()
...
with open('D:/TP SAE 1-05/SAE15(1)/SAE15/données.csv', 'w', newline='') as fichiercsv:
...
with open('D:/TP SAE 1-05/SAE15(1)/SAE15/Stats.csv', 'w', newline='') as fichier2:
...
with open("D:/TP SAE 1-05/SAE15(1)/SAE15/data.html","w") as html:
